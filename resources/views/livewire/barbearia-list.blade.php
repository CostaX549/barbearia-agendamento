<div>
  ...
  <div class="grid  grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 p-5 ">
  ...
  <div class="p-6">
    ...
    <p class="mb-2 text-base text-neutral-600">
     ...
     if ($avaliacoes->count() == 0) {
         $media = "Nenhuma avaliação";
         $percentagemPreenchimento = 0;
     } else {
         $media = $soma / $avaliacoes->count();
         $percentagemPreenchimento = ($media / 5) * 100; // A média é dividida por 5 (total de estrelas) para obter a porcentagem
     }
  @endphp
