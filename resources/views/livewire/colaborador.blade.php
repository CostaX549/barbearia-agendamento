            ...
            <ul class="flex flex-col pl-0 mb-0 rounded-lg max-h-[300px] overflow-auto">
              ...
              <li class="relative flex justify-between px-4 py-2 pl-0 mb-2 border-0 rounded-t-inherit text-inherit rounded-xl">
                <div class="flex flex-col">
                  <h6 class="mb-1 text-sm font-semibold leading-normal dark:text-white text-slate-700">{{ \Carbon\Carbon::parse($fatura['debit_date'])->format('d/m/Y H:i') }}</h6>
         ...
         @foreach($this->barbearia->barbeiros()->withTrashed()->get() as $barbeiro)
              ...
              <li class="relative flex p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50 dark:bg-slate-850">
                ...
                <div class="ml-auto text-right">
                 ...
                 @endif
                  <a class="inline-block dark:text-white px-4 py-2.5 mb-0 font-bold text-center align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-normal text-sm ease-in bg-150 hover:-translate-y-px active:opacity-85 bg-x-25 text-slate-700" href="javascript:;"><i class="mr-2 fas fa-pencil-alt text-slate-700" aria-hidden="true"></i>Editar</a>
                </div>
              </li>
