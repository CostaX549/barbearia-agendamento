...
x-intersect="shownHome = true;"
    ...
    style="
      background-image: url('http://localhost/6c082904e4c74374b352ad53b2b2a8be (1) (1).png');
      height: 850px;
    ...
    >
{{--     Versão Homem: http://localhost/6c082904e4c74374b352ad53b2b2a8be-_1_-_1_-min.webp
...
<div class="zoom relative overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="dark" >
    ...
    @else
        <img src="http://localhost/storage/{{ $galeria['foto'] }}" data-te-caption="{{ $galeria['descricao'] }}" data-te-img="http://localhost/storage/{{ $galeria['foto'] }}" class="w-[400px] max-h-[400px]   xl:min-h-[350px] lg:min-h-[250px]  object-cover align-middle transition duration-300 ease-linear" />
    @endif
</div>
@endforeach
</div>
      ...
      <div class="relative  overflow-y-auto p-4">
        <div  data-te-lightbox-init wire:ignore.self class="grid gap-4 lg:grid-cols-3 mx-auto">
          ...
          <div class="zoom relative overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="dark" >
              ...
              <img  src="http://localhost/storage/{{ $galeria['foto'] }}"   data-te-caption="{{ $galeria['descricao'] }}" data-te-img="http://localhost/storage/{{ $galeria['foto'] }}" class="w-full max-h-[200px]    object-cover align-middle transition duration-300 ease-linear" />
              @endif
          </div>
       @endforeach
    </div>
    ...
    <div
      ...
      <div class="flex flex-wrap items-center">
        <div class="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
          <img src="http://localhost/storage/{{ $barbearia->imagem }}" alt="Trendy Pants and Shoes"
