...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="pt-6">
    <div id="header-content" class="pl-4">
      <img
        ...
        alt="Avatar"
        class="mb-4 rounded-full align-middle"
        style="width: 50px; height: 50px;" />

      <h4 class="mb-2 text-2xl font-medium leading-[1.2]">{{ $barbearia->nome }}</h4>
      <p class="mb-4">{{ $barbearia->owner->name }}</p>
    </div>
  ...
  <div id="scrollContainer">
    <ul
      ...
      <li class="relative">
        <x-barbearia-link  :href="route('horarios', ['slug' => $barbearia->slug])"  :active="request()->routeIs('horarios')" wire:navigate>
          <span
          class="mr-4 [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:fill-gray-700 dark:[&>svg]:fill-gray-300">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li class="relative">
        <x-barbearia-link  :href="route('barbearia.agendamentos', ['slug' => $barbearia->slug])"  :active="request()->routeIs('barbearia.agendamentos')" wire:navigate>
          <span
          class="mr-4 [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:fill-gray-700 dark:[&>svg]:fill-gray-300">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li class="relative">
        <x-barbearia-link  :href="route('deletar', ['slug' => $barbearia->slug])"  :active="request()->routeIs('deletar')" wire:navigate>
          <span
            class="mr-4 [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:fill-gray-700 dark:[&>svg]:fill-gray-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
